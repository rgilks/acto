...
export const secondaryButtonClass = `${buttonBaseClass} text-gray-300 bg-gray-700 hover:bg-gray-600 focus:ring-indigo-500`;
export const refreshButtonClass = `${buttonBaseClass} text-white bg-green-600 hover:bg-green-700 focus:ring-green-500`;
